...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/28 10:17:26 by sefaertnc         #+#    #+#             */
/*   Updated: 2025/04/28 10:17:26 by sefaertnc        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    int  tests[]    = { '0', '5', '9', '/', ':', 'a', '\n', -1, 200 };
    int  expected[] = {   2048,   2048,   2048,   0,   0,   0,   0,    0,   0 };
    ...
    {
        if (ft_isdigit(tests[i]) != expected[i])
        {
            ok       = 0;
            failed_i = i;
            break;
